...
func logPokemonStats(statsDb *sqlx.DB) {
	...
	go func() {
		...
		for area, stats := range currentStats {
			...
			statsCollector.BlisseyStats(area.Parent, "monsSeen", float64(stats.monsSeen))
			statsCollector.BlisseyStats(area.Parent, "monsIv", float64(stats.monsIv))
			statsCollector.BlisseyStats(area.Parent, "verifiedEnc", float64(stats.verifiedEnc))
			statsCollector.BlisseyStats(area.Parent, "verifiedReEncounter", float64(stats.verifiedReEncounter))
			statsCollector.BlisseyStats(area.Parent, "unverifiedEnc", float64(stats.unverifiedEnc))

			statsCollector.BlisseyStats(area.Parent, "verifiedEncSecTotal", float64(stats.verifiedEncSecTotal))
			statsCollector.BlisseyStats(area.Parent, "max5", float64(stats.tthBucket[0]))
			statsCollector.BlisseyStats(area.Parent, "5to10", float64(stats.tthBucket[1]))
			statsCollector.BlisseyStats(area.Parent, "10to15", float64(stats.tthBucket[2]))
			statsCollector.BlisseyStats(area.Parent, "15to20", float64(stats.tthBucket[3]))
			statsCollector.BlisseyStats(area.Parent, "20to25", float64(stats.tthBucket[4]))
			statsCollector.BlisseyStats(area.Parent, "25to30", float64(stats.tthBucket[5]))
			statsCollector.BlisseyStats(area.Parent, "30to35", float64(stats.tthBucket[6]))
			statsCollector.BlisseyStats(area.Parent, "35to40", float64(stats.tthBucket[7]))
			statsCollector.BlisseyStats(area.Parent, "40to45", float64(stats.tthBucket[8]))
			statsCollector.BlisseyStats(area.Parent, "45to50", float64(stats.tthBucket[9]))
			statsCollector.BlisseyStats(area.Parent, "50to55", float64(stats.tthBucket[10]))
			statsCollector.BlisseyStats(area.Parent, "min55", float64(stats.tthBucket[11]))

			statsCollector.BlisseyStats(area.Parent, "statsResetCount", float64(stats.statsResetCount))
			statsCollector.BlisseyStats(area.Parent, "verifiedReEncSecTotal", float64(stats.verifiedReEncSecTotal))
			statsCollector.BlisseyStats(area.Parent, "timeToEncounterCount", float64(stats.timeToEncounterCount))
			statsCollector.BlisseyStats(area.Parent, "timeToEncounterSum", float64(stats.timeToEncounterSum))
		}
